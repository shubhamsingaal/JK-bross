...
const Modal = ({ open, setOpen, children, submitText, closeText, title, onCloseClick, onSubmitClick }) => {
            ...
            <Dialog as="div" className="relative z-10" onClose={() => setOpen(false)}>
                ...
                <div className="flex min-h-full items-center justify-center py-4 text-center">
                    ...
                    <Dialog.Panel 
                        ...
                        <Dialog.Title
                            as="h3"
                            className="text-md font-playfair font-medium leading-6 pl-4 pb-4 text-textPrimary flex gap-2"
                            >
