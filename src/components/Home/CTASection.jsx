                ...
                <div className='w-[40%] min-w-[20rem] mt-[2rem] md:mt-[-4rem]'>
                    <div className='bg-[#F5F7FE] w-[100%] min-h-[35rem] border-2 border-[#D8E3FF] rounded-3xl p-8'>
                        ...
                        <form className='md:pt-6 pt-4' onSubmit={(e) => { e.preventDefault() }}>
                                ...
                                <input placeholder='Your Name' className='w-full p-2 border-2 border-[#D8E3FF] rounded-xl text-lg mb-6'/>
                                ...
                                <input type="text" class=" border-2 text-lg border-[#D8E3FF] rounded-xl w-full p-2" placeholder="Location"></input>
