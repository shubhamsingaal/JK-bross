...
const CTASection = () => {
    ...
    const [ selectItemsModal, SetSelectItemsModal ] = useState(hasErrors)
    ...
    const handleOnChange = (e) => {
        ...
        if (formErrors[name]) {
            ...
            case 'movingTo':
                error = value.length < 3 ? 'Location must be at least 3 characters' : '';
                break;
  ...
  return (
    <div className='w-[100svw] flex justify-center'>
        <div className='lg:w-[70%] w-[90%] mt-[2rem]'>
            ...
            <div className='w-[100%] flex gap-x-4 md:flex-row flex-col md:items-start items-center'>
                ...
                <div className='md:w-[40%] w-[90%] min-w-[20rem] mt-[2rem] md:mt-[-4rem]'>
                    <div className='bg-[#F5F7FE] w-[100%] min-h-[35rem] border-2 border-[#D8E3FF] rounded-3xl p-8'>
                        <h1 className='text-xl font-semibold'>Instant Quote Calculator</h1>

                        <form className='md:pt-6 pt-4 flex flex-col gap-y-6' onSubmit={handleSubmit}>
                                ...
                                <div className=''>
                                <label for="fromLocation" className="mt-4 text-md text-gray-400">Moving From</label>
                                ...
                                <div className=''>
                                <label for="fromLocation" className="mt-4 text-md text-gray-400">Moving to</label>
                                <div className="relative">
                                    <input 
                                        type="text" 
                                        class=" border-2 text-lg border-[#D8E3FF] rounded-xl w-full p-2" 
                                    ...
                                    <div className="text-red-500 text-sm">{formErrors?.movingTo}</div>
                                </div>
                                
                                <div className=''>
                                <label for="fromLocation" className="mt-4 text-md text-gray-400">Moving On</label>
                                <div className="relative">
                                <input 
                                    type="date" 
                                    class=" border-2 text-lg border-[#D8E3FF] rounded-xl w-full p-2" 
                                    ...
                                    onChange={handleOnChange}
                                    ></input>
                                    <div className="text-red-500 text-sm">{formErrors?.movingOn}</div>
                                    <div className="absolute inset-y-0 end-3 flex items-center pointer-events-none">
                                    {/* Calender SVG */}
            ...
            {
                selectItemsModal && (
                    <SelectItemsModal open={selectItemsModal} setOpen={() => { SetSelectItemsModal(false) }} />
                )
            }
        </div>
    </div>
