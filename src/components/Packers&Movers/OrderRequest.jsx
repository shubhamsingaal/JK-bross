...
const OrderRequest = () => {
    return (
        <div className="flex w-[360px] h-[243px] mt-5 mb-8 bg-gray-200 rounded-xl text-left text-xs text-black font-inter relative p-10 ml-10 mr-10">
            ...
            <button className="cursor-pointer p-0 bg-[transparent] absolute top-[178px] left-[188px] w-[157px] h-[50px]">
                <div className="rounded-xl  border-blue-500 border-2 bg-white text-blue-600 box-border w-[157px] h-[50px] border-[1px] border-solid border-royalblue" />
